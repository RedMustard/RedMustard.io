const Soundcloud = () => (
    <svg className="icon soundcloud-icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="130px" height="130px" viewBox="0 0 130 130" enableBackground="new 0 0 130 130" xmlSpace="preserve">
        <rect fill="none" width="130" height="130" />
        <g id="SoundCloud_icon_1_">
            <path
                fill="#75cf00"
                d="M28.442,48.186c-0.974,0-1.763,0.54-1.8,1.221l-1.314,29.126l1.314,14.201
